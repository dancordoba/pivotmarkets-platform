/**
 * Jasper - Furniture Manufacturing Hub
 * 
...
const jasperData = {
  ...
  roiScenarios: [
    {
      scenario: "Traditional Manufacturing R&D",
      yearlyCapex: "$600,000",
      yearlyOpex: "$400,000",
      totalFirstYear: "$1,000,000",
      withGrants: "$200,000 (80% funded)"
    },
    {
      scenario: "AI-Powered Design-to-Manufacture",
      yearlyCapex: "$350,000",
      yearlyOpex: "$200,000",
      totalFirstYear: "$550,000",
      withGrants: "$110,000 (80% funded)"
    },
    {
      scenario: "Sovereign Manufacturing Intelligence",
      yearlyCapex: "$400,000",
      yearlyOpex: "$250,000",
      totalFirstYear: "$650,000",
      withGrants: "$130,000 (80% funded)"
    }
  ]
};
...
export default function Jasper() {
  ...
  useEffect(() => {
    ...
    const citySchemas = [
      createCityPlaceSchema(jasperData.name, jasperData.industry, "~15,000"),
      createCityLocalBusinessSchema(
        jasperData.name,
        jasperData.industry,
        jasperData.chamber.name,
        jasperData.chamber.url
      ),
      createCityHubOrganizationSchema(
        jasperData.name,
        jasperData.industry,
        ...
        <div className="container max-w-6xl mx-auto">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href={jasperData.chamber.url} target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-primary hover:text-primary/80 transition-colors">
                {jasperData.chamber.name}
              </a>
            </div>
          </div>
        ...
        <div className="container max-w-6xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground">
              {jasperData.name}: The Million-Dollar Grant Stack
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Transform {jasperData.industry} with sovereign R&D infrastructure. Leverage READI 2.0, Manufacturing Readiness Grants, and Big 3 Cloud Credits to accelerate design-to-manufacture cycles and reduce costs by up to 80%.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <Card className="p-8 bg-white dark:bg-slate-900 border border-border">
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h3 className="text-2xl font-bold text-foreground">{jasperData.grantStack.readi.name}</h3>
                  <p className="text-lg text-primary font-semibold mt-2">{jasperData.grantStack.readi.amount}</p>
                </div>
                <span className="px-3 py-1 bg-primary/10 text-primary text-xs font-semibold rounded">
                  Indiana State
                </span>
              </div>
              <p className="text-muted-foreground mb-6">{jasperData.grantStack.readi.description}</p>
              <Button variant="outline" asChild>
                <a href={jasperData.grantStack.readi.url} target="_blank" rel="noopener noreferrer">
            ...
            <Card className="p-8 bg-white dark:bg-slate-900 border border-border">
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h3 className="text-2xl font-bold text-foreground">{jasperData.grantStack.manufacturing.name}</h3>
                  <p className="text-lg text-primary font-semibold mt-2">{jasperData.grantStack.manufacturing.amount}</p>
                </div>
              ...
              <p className="text-muted-foreground mb-6">{jasperData.grantStack.manufacturing.description}</p>
              <Button variant="outline" asChild>
                <a href={jasperData.grantStack.manufacturing.url} target="_blank" rel="noopener noreferrer">
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {jasperData.grantStack.cloudCredits.map((cloud, idx) => (
        ...
        <div className="container max-w-6xl mx-auto">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              ...
              <tbody>
                {jasperData.roiScenarios.map((scenario, idx) => (
          ...
          <div className="mt-8 p-6 bg-primary/5 border border-primary/20 rounded-lg">
            <p className="text-sm text-muted-foreground leading-relaxed">
              <strong>Grant Stack Strategy:</strong> By combining READI 2.0 ($500K-$2M), Manufacturing Readiness Grants ($50K-$500K), and Big 3 Cloud Credits ($300K combined), {jasperData.name} furniture manufacturers can fund sovereign R&D infrastructure with minimal capital requirements. This accelerates design-to-manufacture cycles, enables local data residency, and positions {jasperData.name} as a leader in intelligent furniture manufacturing.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">{jasperData.name} - Sovereign R&D Hub Architect</p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href={jasperData.chamber.url} target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">{jasperData.chamber.name}</a></li>
          ...
          <div className="border-t border-border pt-8 text-center">
            <p className="text-sm text-muted-foreground">
              &copy; 2026 PivotMarkets.ai. Architecting {jasperData.name}'s Sovereign R&D Hub. | 
