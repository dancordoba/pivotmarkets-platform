/**
 * Nappanee - Artisan Woodworking & Crafts Hub
 * 
...
const nappaneeData = {
  ...
  chamber: {
    name: "Nappanee Chamber of Commerce",
    url: "https://nappaneechamber.com"
  },
  grantStack: {
    readi: {
  ...
  roiScenarios: [
    {
      scenario: "Traditional R&D Infrastructure",
      yearlyCapex: "$500,000",
      yearlyOpex: "$300,000",
      totalFirstYear: "$800,000",
      withGrants: "$0 (100% funded)"
    },
    {
      scenario: "AI-Powered Craft Optimization",
      yearlyCapex: "$250,000",
      yearlyOpex: "$150,000",
      totalFirstYear: "$400,000",
      withGrants: "$80,000 (80% funded)"
    },
    {
      scenario: "Sovereign Data Hub",
      yearlyCapex: "$300,000",
      yearlyOpex: "$200,000",
      totalFirstYear: "$500,000",
      withGrants: "$100,000 (80% funded)"
    }
  ]
};

export default function Nappanee() {
  ...
  useEffect(() => {
    ...
    const citySchemas = [
      createCityPlaceSchema(nappaneeData.name, nappaneeData.industry, "~6,500"),
      createCityLocalBusinessSchema(
        nappaneeData.name,
        nappaneeData.industry,
        nappaneeData.chamber.name,
        nappaneeData.chamber.url
      ),
      createCityHubOrganizationSchema(
        nappaneeData.name,
        nappaneeData.industry,
    ...
    // GovernmentService schema for Nappanee civic program (with Stanford validation)
    const nappaneeGovernmentServiceSchema = {
      "@context": "https://schema.org",
      "@type": "GovernmentService",
      "name": "Nappanee Sovereign AI Regional Hub - Grant-Ready Infrastructure",
      "description": "Civic program for artisan manufacturers to access $2.7M+ grant stack and sovereign AI infrastructure validated by Stanford AI Index benchmarks.",
      "provider": {
        "@type": "Organization",
    ...
    script4.textContent = JSON.stringify(nappaneeGovernmentServiceSchema);
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container max-w-6xl mx-auto">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href={nappaneeData.chamber.url} target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-primary hover:text-primary/80 transition-colors">
                {nappaneeData.chamber.name}
              </a>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-primary/5 to-background">
        <div className="container max-w-6xl mx-auto">
          ...
          <Card className="mb-12 p-6 border-2 border-accent bg-accent/5">
            <div className="flex gap-4 items-start">
              <div className="text-2xl">📊</div>
              <div>
                <h3 className="font-semibold mb-2">Grounded in Stanford Research</h3>
                <p className="text-sm text-muted-foreground">
                  The <a href="https://aiindex.stanford.edu/" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold hover:underline">2026 Stanford AI Index</a> confirms a 1.7% performance gap between open and closed models. Nappanee's sovereign infrastructure delivers frontier-level intelligence at 1/7th the cost.
                </p>
              </div>
            </div>
          </Card>
          ...
          <div className="text-center space-y-4 mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground">
              {nappaneeData.name}: The Million-Dollar Grant Stack
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Build a sovereign R&D hub for {nappaneeData.industry} at a fraction of the cost. Leverage READI 2.0, Manufacturing Readiness Grants, and Big 3 Cloud Credits to fund your AI transformation.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <Card className="p-8 bg-white dark:bg-slate-900 border border-border">
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h3 className="text-2xl font-bold text-foreground">{nappaneeData.grantStack.readi.name}</h3>
                  <p className="text-lg text-primary font-semibold mt-2">{nappaneeData.grantStack.readi.amount}</p>
                </div>
                <span className="px-3 py-1 bg-primary/10 text-primary text-xs font-semibold rounded">
                  Indiana State
                </span>
              </div>
              <p className="text-muted-foreground mb-6">{nappaneeData.grantStack.readi.description}</p>
              <Button variant="outline" asChild>
                <a href={nappaneeData.grantStack.readi.url} target="_blank" rel="noopener noreferrer">
            ...
            <Card className="p-8 bg-white dark:bg-slate-900 border border-border">
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h3 className="text-2xl font-bold text-foreground">{nappaneeData.grantStack.manufacturing.name}</h3>
                  <p className="text-lg text-primary font-semibold mt-2">{nappaneeData.grantStack.manufacturing.amount}</p>
                </div>
              ...
              <p className="text-muted-foreground mb-6">{nappaneeData.grantStack.manufacturing.description}</p>
              <Button variant="outline" asChild>
                <a href={nappaneeData.grantStack.manufacturing.url} target="_blank" rel="noopener noreferrer">
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {nappaneeData.grantStack.cloudCredits.map((cloud, idx) => (
        ...
        <div className="container max-w-6xl mx-auto">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              ...
              <tbody>
                {nappaneeData.roiScenarios.map((scenario, idx) => (
          ...
          <div className="mt-8 p-6 bg-primary/5 border border-primary/20 rounded-lg">
            <p className="text-sm text-muted-foreground leading-relaxed">
              <strong>Grant Stack Strategy:</strong> By combining READI 2.0 ($500K-$2M), Manufacturing Readiness Grants ($50K-$500K), and Big 3 Cloud Credits ($300K combined), {nappaneeData.name} artisan manufacturers can fund sovereign R&D hubs with minimal out-of-pocket costs. This enables rapid AI adoption, local data residency, and competitive advantage in the global artisan economy.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">{nappaneeData.name} - Sovereign R&D Hub Architect</p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href={nappaneeData.chamber.url} target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">{nappaneeData.chamber.name}</a></li>
          ...
          <div className="border-t border-border pt-8 text-center">
            <p className="text-sm text-muted-foreground">
              &copy; 2026 PivotMarkets.ai. Architecting {nappaneeData.name}'s Sovereign R&D Hub. | 
